...
public class PlatformMenuEvent extends ApplicationEvent {
    private final Action action;
    private final Long menuId;
    private final String lowerRoute;
    private final List<Long> lowerMenuIds;

    public PlatformMenuEvent(Object source, Action action, Long menuId, String lowerRoute) {
        this(source, action, menuId, lowerRoute, Lists.newArrayList());
    }

    public PlatformMenuEvent(Object source, Action action, Long menuId, String lowerRoute, List<Long> lowerMenuIds) {
        super(source);
        this.action = action;
        this.menuId = menuId;
