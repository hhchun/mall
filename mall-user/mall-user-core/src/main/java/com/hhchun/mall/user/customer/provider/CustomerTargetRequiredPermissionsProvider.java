...
@Slf4j
public class CustomerTargetRequiredPermissionsProvider implements TargetRequiredPermissionsProvider {

    private final CustomerAccessPermissionCache cache;

    public CustomerTargetRequiredPermissionsProvider(CustomerAccessPermissionCache cache) {
        this.cache = cache;
    }
